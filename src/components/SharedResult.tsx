...
export default function SharedResult({ code }: { code: string }) {
  ...
  return (
    <>
      <div
        className="flex shrink-0 items-center justify-between border-b-2 border-[#c96442] mb-1 pb-[3px]"
      ...
      >
        <div className="flex items-center gap-1.5">
          <button
            ...
            className={`inline-flex h-[1.6em] cursor-pointer items-center justify-center gap-[0.2em] rounded border px-[0.4em] text-[0.8em] font-bold leading-none ${
              pipOpen
                ...
                : "border-[#54524c] bg-[#30302e] text-[#c96442] hover:border-[#c96442] hover:bg-[#3a3936]"
            }`}
            onClick={togglePip}
          ...
          <div className="text-[1.1em] font-bold text-[#c96442]">🏁 最終結果</div>
        </div>
        <span
